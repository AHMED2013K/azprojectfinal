...
const envSchema = z.object({
  ...
  BACKUP_RETENTION_COUNT: z.coerce.number().int().positive().optional().default(20),
  BACKUP_OUTPUT_DIR: z.string().trim().optional().default(''),
  BACKUP_UPLOAD_URL: z.string().trim().optional().default(''),
  BACKUP_UPLOAD_METHOD: z.enum(['PUT', 'POST']).optional().default('PUT'),
  BACKUP_UPLOAD_AUTH_TOKEN: z.string().trim().optional().default(''),
  MONITORING_HEARTBEAT_URL: z.string().trim().optional().default(''),
  ALERT_WEBHOOK_URL: z.string().trim().optional().default(''),
  MONITORING_HEARTBEAT_INTERVAL_MS: z.coerce.number().int().positive().optional().default(60000),
  MONITORING_ALERT_COOLDOWN_MS: z.coerce.number().int().positive().optional().default(300000),
  MONITORING_MEMORY_ALERT_MB: z.coerce.number().int().positive().optional().default(700),
