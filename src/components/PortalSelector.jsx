...
const portalCopy = {
  en: {
    ...
    partnerTitle: 'AI Growth Systems',
    partnerDescription:
      'Scale admissions, LinkedIn prospecting, and CRM qualification with AI-assisted workflows and expert supervision.',
    partnerFeatures: ['AI lead qualification', 'LinkedIn prospecting', 'CRM automation'],
    partnerCta: 'Audit My Pipeline',
  ...
  fr: {
    ...
    partnerTitle: 'Systèmes Growth IA',
    partnerDescription:
      "Scalez vos admissions, votre prospection LinkedIn et votre qualification CRM avec des workflows IA supervisés par des experts.",
    partnerFeatures: ['Qualification IA', 'Prospection LinkedIn', 'Automatisation CRM'],
    partnerCta: 'Auditer mon pipeline',
