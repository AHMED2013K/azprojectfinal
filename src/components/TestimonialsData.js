...
export const studentAbroadTestimonials = [
  {
    name: "Yasmine Dridi",
    destination: "France",
    program: "Alternance Business",
    content: "I was overwhelmed with Campus France applications from Tunisia. Abroad Zone handled my entire dossier, found me a perfect alternance contract, and got my visa approved first try. Now studying and earning in Paris!",
    rating: 5,
    avatar: "🇹🇳"
  },
  {
    ...
    content: "Confused by CAQ vs study permit processes for study abroad Tunisia students. Abroad Zone guided me step-by-step, secured Montreal Polytechnic admission, and handled all documents. Dreaming became reality!",
    rating: 5,
    avatar: "🇹🇳"
  },
  {
    name: "Selima Ben Rejeb",
    destination: "Italy",
    program: "Architecture",
    content: "Universitaly portal was a nightmare. Abroad Zone prepared my portfolio, handled pre-enrollment, and visa from Tunisia. Now designing in Rome – couldn't have done it without their local expertise.",
    rating: 5,
    avatar: "🇹🇳"
  },
  {
    ...
    destination: "Russia",
    program: "Medicine",
    content: "Russian medical school admissions seemed impossible from Tunisia. Abroad Zone managed translations, equivalences, and invitations. Accepted to top university, visa in hand, starting year 1!",
    rating: 5,
    avatar: "🇹🇳"
  },
  {
    ...
    content: "Dubai study abroad Tunisia was my goal but overwhelming. Abroad Zone found my perfect program at University of Dubai, handled sponsorship visa, and accommodation. Thriving in the UAE now!",
    rating: 5,
    avatar: "🇹🇳"
  },
  {
    ...
    program: "Engineering",
    content: "Needed affordable EU-recognized degree for study abroad Tunisia. Abroad Zone secured 75% scholarship at Near East University, fast-tracked visa, and helped settle in. Best decision ever!",
    rating: 5,
    avatar: "🇹🇳"
  }
];
