...
export default function BlogHubPage() {
  ...
  const published = [
    ...
    { slug: '/campus-france-tunisie-guide', label: 'Campus France Tunisie guide' },
    ...
    { slug: '/blog/entretien-campus-france-questions-reponses', label: 'Entretien Campus France : questions et réponses' },
    { slug: '/blog/lettre-motivation-campus-france-exemple', label: 'Lettre de motivation Campus France : exemple' },
    { slug: '/blog/compte-bloque-allemagne-tunisie', label: 'Compte bloqué Allemagne Tunisie' },
    { slug: '/blog/visa-etudiant-france-tunisie-documents', label: 'Visa étudiant France Tunisie : documents' },
    { slug: '/blog/ausbildung-allemagne-tunisiens-conditions', label: 'Ausbildung Allemagne pour les Tunisiens' },
    { slug: '/blog/etudier-medecine-roumanie-tunisie', label: 'Étudier médecine en Roumanie depuis la Tunisie' },
    { slug: '/blog/quel-pays-etudier-petit-budget', label: 'Quel pays choisir avec un petit budget ?' },
    { slug: '/blog/logement-etudiant-france-depuis-tunisie', label: 'Logement étudiant en France depuis la Tunisie' },
    { slug: '/blog/master-france-apres-licence-tunisie', label: 'Master en France après licence en Tunisie' },
    { slug: '/blog/etudier-a-chypre-depuis-la-tunisie', label: 'Étudier à Chypre depuis la Tunisie' },
    { slug: '/blog/etudier-en-turquie-depuis-la-tunisie', label: 'Étudier en Turquie depuis la Tunisie' },
    { slug: '/blog/etudier-a-dubai-depuis-la-tunisie', label: 'Étudier à Dubai depuis la Tunisie' },
    { slug: '/blog/documents-admission-internationale-tunisie', label: 'Documents admission internationale depuis la Tunisie' },
