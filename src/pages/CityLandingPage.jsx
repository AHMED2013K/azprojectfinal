        ...
        <div className="mx-auto max-w-4xl rounded-3xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 p-4">
              ...
              <p className="mt-2 text-sm">Sélection pays/programme selon budget et profil.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 p-4">
              <p className="text-sm font-black uppercase text-slate-500">Admissions</p>
              <p className="mt-2 text-sm">Montage dossier, deadlines, suivi candidatures.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 p-4">
              <p className="text-sm font-black uppercase text-slate-500">Visa</p>
              <p className="mt-2 text-sm">Checklist visa, préparation entretien, conformité docs.</p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(`Bonjour, je suis à ${data.city} et je veux étudier à l'étranger.`)}`}
              target="_blank"
          ...
          <section className="mt-10 rounded-2xl bg-slate-950 p-6 text-white">
            <h2 className="flex items-center gap-2 text-2xl font-black"><Building2 size={22} /> Presence locale + accompagnement digital</h2>
            <p className="mt-3 text-slate-300">Notre équipe suit votre dossier en continu avec un support rapide sur WhatsApp et une méthode structurée jusqu'au départ.</p>
