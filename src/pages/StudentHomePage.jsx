...
const destinations = [
  ...
  {
    name: 'Hongrie',
    path: '/etudier-en-hongrie-depuis-tunisie',
    focus: 'Médecine, ingénierie, programmes en anglais',
    timing: 'Très pertinent pour filières santé',
    image: 'https://images.unsplash.com/photo-1549877452-9c387954fbc2?auto=format&fit=crop&w=700&q=80',
  },
  {
    name: 'Canada',
  ...
  {
    name: 'Espagne',
    path: '/etudier-en-espagne-depuis-tunisie',
    focus: 'Universités européennes accessibles, coût modéré',
    timing: 'Bon choix pour cursus internationaux',
    image: 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?auto=format&fit=crop&w=700&q=80',
  },
  {
    name: 'Chine',
    path: '/etudier-en-chine-depuis-tunisie',
    focus: 'Bourses, médecine, ingénierie',
    timing: 'Anticiper bourses et visa',
    image: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=700&q=80',
  },
  {
    name: 'Maroc',
...
const copy = {
  fr: {
    ...
    navAbout: 'A propos',
    navContact: 'Contact',
    navPartners: 'Growth IA B2B',
    navBusiness: 'Growth IA',
  ...
  en: {
    ...
    navAbout: 'About',
    navContact: 'Contact',
    navPartners: 'B2B AI Growth',
    navBusiness: 'AI Growth',
