...
const pages = {
  ...
  '/fr/etudier-medecine-pharmacie-etranger': {
    ...
    description: 'Étudier médecine, dentaire ou pharmacie à l’étranger depuis la Tunisie: Roumanie, Europe, frais, langue, reconnaissance et visa.',
    ...
    sections: [
      {
        ...
        body: "La Roumanie, certains pays européens et des parcours internationaux peuvent être étudiés selon le niveau, le budget et la reconnaissance du diplôme.",
        h3: ['Roumanie et Europe', 'Filières en anglais ou français', 'Admission sur dossier'],
      },
      {
        h2: 'Frais, langue et reconnaissance',
        body: "Il faut vérifier les frais annuels, la langue d'enseignement, les stages, la reconnaissance internationale et les conditions d'équivalence en Tunisie.",
  ...
  '/en/study-medicine-pharmacy-abroad': {
    ...
    description: 'Study medicine, dentistry or pharmacy abroad from Tunisia: Romania, Europe, tuition, language, recognition and visa guidance.',
    ...
    sections: [
      {
        ...
        body: 'Romania, selected European countries and international pathways may be considered depending on grades, budget and degree recognition.',
        h3: ['Romania and Europe', 'English or French tracks', 'Application-based admission'],
      },
      {
        h2: 'Fees, language and recognition',
        body: 'Students must check annual tuition, teaching language, internships, international recognition and equivalence rules in Tunisia.',
  ...
  '/fr/medecine-privee-tunisie': {
    lang: 'fr',
    title: 'Médecine privée en Tunisie | Options',
    description: 'Médecine privée en Tunisie: ce qui existe, ce qui n’existe pas, alternatives santé privées et études médicales à l’étranger.',
    h1: 'Médecine privée en Tunisie : options réelles',
    eyebrow: 'Clarification importante',
    intro: "À ce jour, il n'existe pas de facultés privées agréées en Tunisie pour médecine générale ou pharmacie comme alternative directe aux facultés publiques. Il faut donc distinguer santé privée en Tunisie et médecine à l'étranger.",
    cta: 'Comparer mes options santé',
    whatsapp: 'Bonjour EduGrowth, je cherche une option pour médecine privée ou santé.',
    sections: [
      {
        h2: "Ce qui n'existe pas en Tunisie",
        body: "La médecine générale et la pharmacie privées agréées comme facultés complètes ne constituent pas aujourd'hui une voie locale classique en Tunisie.",
        h3: ['Pas de promesse trompeuse', 'Vérification agrément', 'Décision familiale informée'],
      },
      {
        h2: 'Alternatives privées santé en Tunisie',
        body: "Les étudiants peuvent étudier certaines filières paramédicales ou sciences de la santé privées: kinésithérapie, anesthésie, sciences infirmières ou domaines connexes selon agrément.",
        h3: ['Paramédical', 'Sciences infirmières', 'Kinésithérapie'],
      },
      {
        h2: 'Médecine, pharmacie et dentaire à l’étranger',
        body: "Pour viser médecine générale, pharmacie ou dentaire, l'alternative peut être une faculté à l'étranger, notamment en Roumanie ou en Europe selon budget et reconnaissance.",
        h3: ['Roumanie', 'Europe', 'Reconnaissance et équivalence'],
      },
    ],
    faq: [
      ['Existe-t-il une médecine générale privée en Tunisie ?', "Pas comme faculté privée agréée classique pour médecine générale. Il faut vérifier toute affirmation auprès des autorités compétentes."],
      ['Quelle alternative pour un bachelier ?', "Comparer les filières santé privées en Tunisie et les études médicales à l'étranger selon budget, notes et reconnaissance."],
    ],
  },
  '/en/private-medicine-tunisia': {
    lang: 'en',
    title: 'Private Medicine in Tunisia | Options',
    description: 'Private medicine in Tunisia: what exists, what does not, private health programs and medical studies abroad for Tunisian students.',
    h1: 'Private medicine in Tunisia: realistic options',
    eyebrow: 'Important clarification',
    intro: 'At this stage, Tunisia does not offer a standard accredited private route for general medicine or pharmacy as a direct alternative to public medical faculties. Students must distinguish private health programs in Tunisia from medical studies abroad.',
    cta: 'Compare my health options',
    whatsapp: 'Hello EduGrowth, I am looking for private medicine or health study options.',
    sections: [
      {
        h2: 'What does not exist in Tunisia',
        body: 'Private general medicine and pharmacy faculties are not currently a standard local pathway in Tunisia.',
        h3: ['No misleading promise', 'Accreditation check', 'Informed family decision'],
      },
      {
        h2: 'Private health alternatives in Tunisia',
        body: 'Students may consider private paramedical or health science programs such as physiotherapy, anesthesia, nursing sciences or related fields depending on accreditation.',
        h3: ['Paramedical programs', 'Nursing sciences', 'Physiotherapy'],
      },
      {
        h2: 'Medicine, pharmacy and dentistry abroad',
        body: 'For general medicine, pharmacy or dentistry, the alternative may be a faculty abroad, especially in Romania or Europe depending on budget and recognition.',
        h3: ['Romania', 'Europe', 'Recognition and equivalence'],
      },
    ],
    faq: [
      ['Is there private general medicine in Tunisia?', 'Not as a standard accredited private medical faculty pathway. Any claim should be checked with competent authorities.'],
      ['What can a high-school graduate do?', 'Compare private health fields in Tunisia and medical studies abroad based on budget, grades and recognition.'],
    ],
  },
