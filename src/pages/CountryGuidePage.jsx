...
const countryData = {
  ...
  '/etudier-en-autriche-depuis-tunisie': {
    country: 'Autriche',
    ...
    highlights: [
      "Universités publiques européennes réputées",
      "Option intéressante pour profils cherchant études abordables en Europe",
      "Allemand fortement recommandé, certains programmes existent en anglais",
      "Le budget de vie et les preuves financières doivent être préparés tôt",
    ],
    budget: [
      "Frais universitaires selon statut et établissement",
      "Logement étudiant ou colocation",
      "Assurance santé et frais administratifs",
      "Budget mensuel variable selon ville, surtout Vienne",
    ],
    programs: ['Bachelor', 'Master', 'Ingénierie', 'Business', 'IT', 'Sciences', 'Musique', 'Langue allemande'],
    faq: [
      { q: "L’Autriche est-elle abordable pour les Tunisiens ?", a: "Elle peut l’être côté frais publics, mais le coût de vie et les preuves financières doivent être calculés avec précision." },
      { q: "Peut-on étudier en anglais en Autriche ?", a: "Oui pour certains masters et programmes internationaux, mais l’allemand reste un atout important." },
      { q: "Quels documents préparer ?", a: "Diplômes, relevés, traductions, passeport, preuves financières, assurance et parfois preuve linguistique." },
    ],
    relatedLinks: [
      { to: "/etudier-en-allemagne-depuis-tunisie", label: "Comparer avec Allemagne" },
      { to: "/etudier-en-hongrie-depuis-tunisie", label: "Comparer avec Hongrie" },
      { to: "/blog/bourses-etudes-etranger-tunisiens", label: "Bourses pour Tunisiens" },
      { to: "/book-consultation", label: "Tester mon profil" },
    ],
  },
  '/etudier-en-hongrie-depuis-tunisie': {
    country: 'Hongrie',
    title: "Étudier en Hongrie depuis la Tunisie | Médecine, ingénierie",
    description: "Étudier en Hongrie depuis la Tunisie: médecine, ingénierie, programmes en anglais, coût de vie modéré, admission et visa.",
    h1: "Étudier en Hongrie depuis la Tunisie",
    image: "https://images.unsplash.com/photo-1549877452-9c387954fbc2?auto=format&fit=crop&w=1200&q=80",
    tuition: "Variable selon filière, particulièrement médecine et programmes anglophones",
    visa: "Admission + dossier visa étudiant + preuves financières + logement",
    timeline: ["Choix programme en anglais", "Dossier admission", "Budget et logement", "Visa puis arrivée"],
    highlights: [
      "Destination reconnue pour médecine, ingénierie et sciences",
      "Programmes en anglais accessibles selon niveau et dossier",
      "Coût de vie souvent plus modéré que l’Europe de l’Ouest",
      "Bonne option pour bacheliers tunisiens qui comparent Roumanie et Europe centrale",
    ],
    budget: [
      "Frais élevés possibles en médecine",
      "Logement plus accessible que plusieurs capitales européennes",
      "Assurance, visa, traductions et installation",
      "Budget mensuel à adapter selon Budapest ou ville universitaire",
    ],
    programs: ['Médecine', 'Dentisterie', 'Pharmacie', 'Ingénierie', 'IT', 'Business', 'Bachelor', 'Master'],
    faq: [
      { q: "La Hongrie est-elle forte pour médecine ?", a: "Oui, plusieurs étudiants internationaux la considèrent pour médecine, pharmacie et dentaire, avec vérification stricte des frais et de la reconnaissance." },
      { q: "Les programmes sont-ils en anglais ?", a: "De nombreux programmes internationaux existent en anglais, surtout dans les filières santé, ingénierie et business." },
      { q: "Quel avantage pour les Tunisiens ?", a: "La combinaison Europe, coût de vie modéré et programmes anglophones peut être intéressante selon le profil." },
    ],
    relatedLinks: [
      { to: "/etudier-en-roumanie-depuis-tunisie", label: "Comparer avec Roumanie" },
      { to: "/fr/etudier-medecine-pharmacie-etranger", label: "Médecine à l’étranger" },
      { to: "/etudier-en-autriche-depuis-tunisie", label: "Comparer avec Autriche" },
      { to: "/book-consultation", label: "Tester mon profil" },
    ],
  },
  ...
  '/etudier-en-espagne-depuis-tunisie': {
    country: 'Espagne',
    title: "Étudier en Espagne depuis la Tunisie | Universités européennes",
    description: "Étudier en Espagne depuis la Tunisie: universités accessibles, coût modéré, programmes internationaux, admission, visa et logement.",
    h1: "Étudier en Espagne depuis la Tunisie",
    image: "https://images.unsplash.com/photo-1539037116277-4db20889f2d4?auto=format&fit=crop&w=1200&q=80",
    tuition: "Coût modéré selon université publique, privée et programme international",
    visa: "Admission + visa étudiant Espagne + preuves financières + assurance",
    timeline: ["Choix ville et université", "Admission et documents", "Visa étudiant", "Logement et arrivée"],
    highlights: [
      "Universités européennes accessibles et attractives pour étudiants tunisiens",
      "Options en espagnol et certains programmes internationaux en anglais",
      "Coût souvent plus modéré que plusieurs destinations d’Europe de l’Ouest",
      "Destination à considérer pour business, ingénierie, santé et langues",
    ],
    budget: [
      "Frais selon public/privé et région",
      "Logement variable entre Madrid, Barcelone, Valence et autres villes",
      "Assurance, traductions, visa et installation",
      "Budget de vie à comparer avant candidature",
    ],
    programs: ['Business', 'Ingénierie', 'Médecine', 'Santé', 'Tourisme', 'Langues', 'Bachelor', 'Master'],
    faq: [
      { q: "L’Espagne est-elle accessible aux Tunisiens ?", a: "Oui selon niveau, budget, langue et université. Le dossier visa doit être préparé tôt." },
      { q: "Faut-il parler espagnol ?", a: "Souvent oui pour l’intégration et plusieurs cursus, même si certains programmes internationaux existent en anglais." },
      { q: "L’Espagne convient-elle à médecine privée ?", a: "Elle peut faire partie des options à comparer, mais les frais, places et équivalences doivent être vérifiés avant engagement." },
    ],
    relatedLinks: [
      { to: "/fr/medecine-privee-tunisie", label: "Médecine privée à l’étranger" },
      { to: "/etudier-en-italie-depuis-tunisie", label: "Comparer avec Italie" },
      { to: "/etudier-en-roumanie-depuis-tunisie", label: "Comparer avec Roumanie" },
      { to: "/book-consultation", label: "Tester mon profil" },
    ],
  },
  '/etudier-en-chine-depuis-tunisie': {
    country: 'Chine',
    title: "Étudier en Chine depuis la Tunisie | Bourses, médecine, ingénierie",
    description: "Étudier en Chine depuis la Tunisie: bourses gouvernementales, médecine, ingénierie, programmes internationaux, admission et visa.",
    h1: "Étudier en Chine depuis la Tunisie",
    image: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=1200&q=80",
    tuition: "Frais variables avec possibilités de bourses selon université et programme",
    visa: "Admission universitaire + JW/lettre officielle + visa étudiant + assurance",
    timeline: ["Choix université et bourse", "Dossier admission", "Documents visa", "Préparation départ et logement"],
    highlights: [
      "Bourses gouvernementales et universitaires possibles selon profil",
      "Destination forte pour ingénierie, médecine, technologie et commerce international",
      "Programmes internationaux en anglais disponibles dans certaines universités",
      "Vérifier langue, reconnaissance du diplôme et conditions de retour",
    ],
    budget: [
      "Frais variables selon bourse ou admission directe",
      "Logement campus souvent disponible selon université",
      "Assurance, visa, billet et installation",
      "Budget mensuel à comparer selon ville",
    ],
    programs: ['Médecine', 'Ingénierie', 'IT', 'Business', 'Commerce international', 'Langue chinoise', 'Bachelor', 'Master'],
    faq: [
      { q: "Peut-on obtenir une bourse en Chine ?", a: "Oui, certaines bourses existent, mais elles sont sélectives et nécessitent un dossier préparé tôt." },
      { q: "Peut-on étudier en anglais en Chine ?", a: "Oui dans plusieurs programmes internationaux, notamment médecine, ingénierie et business selon université." },
      { q: "La Chine est-elle adaptée aux Tunisiens ?", a: "Elle peut l’être pour les profils ouverts à une expérience internationale forte, avec vérification de reconnaissance et budget." },
    ],
    relatedLinks: [
      { to: "/blog/bourses-etudes-etranger-tunisiens", label: "Bourses pour Tunisiens" },
      { to: "/fr/etudier-medecine-pharmacie-etranger", label: "Médecine à l’étranger" },
  ...
  '/etudier-au-maroc-depuis-tunisie': {
    ...
    programs: ['Médecine', 'Dentisterie', 'Pharmacie', 'Business', 'Ingénierie', 'Architecture', 'Management', 'Bachelor', 'Master'],
    faq: [
  ...
  '/etudier-en-albanie-depuis-tunisie': {
    country: 'Albanie',
    title: "Étudier en Albanie depuis la Tunisie | Universités, admission et visa",
    description: "Étudier en Albanie depuis la Tunisie : universités, programmes en anglais, admission, budget, logement et préparation du visa étudiant.",
    h1: "Étudier en Albanie depuis la Tunisie",
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Xhamia%20e%20Et-hem%20Beut%20ne%20Tirane.jpg?width=1200",
    tuition: "À vérifier directement auprès de chaque université et programme",
    visa: "Admission universitaire, documents d’identité, financement et procédure consulaire à confirmer",
    timeline: ["Choix du programme et de la langue", "Vérification de l’université", "Dossier d’admission", "Visa et logement"],
    highlights: ["Destination européenne à évaluer selon programme et projet professionnel", "Vérifier précisément la langue d’enseignement", "Comparer le coût global, pas uniquement les frais affichés", "Contrôler la reconnaissance du diplôme avant toute inscription"],
    budget: ["Frais académiques selon établissement", "Logement à Tirana ou dans la ville universitaire", "Assurance, traductions et documents", "Transport et installation"],
    programs: ['Business', 'Informatique', 'Ingénierie', 'Santé', 'Architecture', 'Bachelor', 'Master'],
    faq: [
      { q: "Peut-on étudier en anglais en Albanie ?", a: "Certains établissements proposent des cursus internationaux ; il faut vérifier la langue réelle de chaque programme auprès de l’université." },
      { q: "Comment choisir une université en Albanie ?", a: "Vérifiez l’établissement, le contenu du programme, les conditions d’admission et la reconnaissance correspondant à votre projet." },
      { q: "Faut-il préparer un visa étudiant ?", a: "Les formalités dépendent de votre situation : vérifiez toujours les exigences consulaires officielles avant le départ." },
    ],
    relatedLinks: [{ to: '/etudier-en-italie-depuis-tunisie', label: 'Comparer avec Italie' }, { to: '/etudier-en-roumanie-depuis-tunisie', label: 'Comparer avec Roumanie' }, { to: '/book-consultation', label: 'Évaluer mon projet' }],
  },
  '/etudier-en-malaisie-depuis-tunisie': {
    country: 'Malaisie',
    title: "Étudier en Malaisie depuis la Tunisie | Universités, visa et budget",
    description: "Étudier en Malaisie depuis la Tunisie : universités internationales, admission, Student Pass, budget, logement et programmes en anglais.",
    h1: "Étudier en Malaisie depuis la Tunisie",
    image: "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=1200&q=80",
    tuition: "Variable selon université, niveau et programme international",
    visa: "Admission puis procédure Student Pass avec l’établissement et les canaux officiels EMGS",
    timeline: ["Choix université et programme", "Admission", "Procédure Student Pass", "Logement et arrivée"],
    highlights: ["Destination asiatique avec de nombreux programmes internationaux", "L’anglais est fréquent dans certaines formations, à vérifier programme par programme", "La procédure visa se fait avec l’établissement et les organismes officiels", "Prévoir assurance, examen médical et budget d’installation"],
    budget: ["Frais de scolarité selon établissement", "Logement campus ou privé", "Student Pass, assurance et frais administratifs", "Vol, installation et coût de vie"],
    programs: ['Business', 'Informatique', 'Ingénierie', 'Médecine', 'Sciences', 'Tourisme', 'Bachelor', 'Master'],
    faq: [
      { q: "La Malaisie propose-t-elle des programmes en anglais ?", a: "Oui, plusieurs établissements proposent des cursus internationaux ; vérifiez le programme, ses conditions linguistiques et sa reconnaissance." },
      { q: "Comment se prépare le visa étudiant Malaisie ?", a: "Après admission, la procédure doit être suivie avec l’établissement et les plateformes officielles compétentes, notamment EMGS." },
      { q: "Quel budget prévoir ?", a: "Il faut calculer scolarité, logement, assurance, Student Pass, voyage et dépenses de vie avant de s’engager." },
    ],
